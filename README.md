TWRP 设备配置文件（AllCube i1030m 适配）
 
1. 项目说明
 
本设备树用于为 AllCube i1030m 设备编译 TWRP Recovery，但当前版本存在功能缺陷，仅作为开发阶段的调试记录。
...
mkdir -p device/allcube/i1030m  
cp -r [你的设备树目录] device/allcube/i1030m  

# 编译 recovery 镜像  
source build/envsetup.sh  
lunch twrp_i1030m-eng  
